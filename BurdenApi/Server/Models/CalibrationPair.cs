...
public class CalibrationPair()
{
    ...
    public CalibrationPair? ChangeCoarse(int delta)
        ...
        {
            0 => null,
            +1 => Coarse < 127 ? new CalibrationPair((byte)(Coarse + 1), Fine) : null,
            -1 => Coarse > 0 ? new CalibrationPair((byte)(Coarse - 1), Fine) : null,
    ...
    public CalibrationPair? ChangeFine(int delta)
        ...
        {
            0 => null,
            +1 => Fine < 127 ? new CalibrationPair(Coarse, (byte)(Fine + 1)) : null,
            -1 => Fine > 0 ? new CalibrationPair(Coarse, (byte)(Fine - 1)) : null,
            _ => throw new ArgumentOutOfRangeException(nameof(delta), "delta must be an integral number between -1 and 1 (both inclusive)"),
        };
