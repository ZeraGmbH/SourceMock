...
{
    private Mock<ISourceCapabilityValidator> _validator = null!;
    ...
    {
        var sut = new SerialPortMTSource(_portLogger, _device, new CapabilitiesMap(), _validator.Object);
    ...
    {
        _validator.Setup(v => v.IsValid(It.IsAny<TargetLoadpoint>(), It.IsAny<SourceCapabilities>())).Returns(expectedError);
