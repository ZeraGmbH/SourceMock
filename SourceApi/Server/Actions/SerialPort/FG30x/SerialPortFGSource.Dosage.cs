...
partial class SerialPortFGSource
{
    ...
    public override async Task CancelDosageAsync(IInterfaceLogger logger)
    {
        ...
        await Task.WhenAll(Device.ExecuteAsync(logger, CancellationToken.None, SerialPortRequest.Create("3CM2", "OK3CM2")));
    }
    ...
    public override async Task<DosageProgress> GetDosageProgressAsync(IInterfaceLogger logger, MeterConstant meterConstant)
    {
        ...
        await Task.WhenAll(Device.ExecuteAsync(logger, CancellationToken.None, activeReq, countdownReq, totalReq));
    ...
    public override async Task SetDosageEnergyAsync(IInterfaceLogger logger, ActiveEnergy value, MeterConstant meterConstant)
    {
        ...
        await Device.ExecuteAsync(logger, CancellationToken.None, SerialPortRequest.Create($"3PS45;{(double)value / 1000d}", "OK3PS45"))[0];
    }
    ...
    public override async Task SetDosageModeAsync(IInterfaceLogger logger, bool on)
    {
        ...
        await Task.WhenAll(Device.ExecuteAsync(logger, CancellationToken.None, SerialPortRequest.Create($"3CM{onAsNumber}", $"OK3CM{onAsNumber}")));
    }
    ...
    public override async Task StartDosageAsync(IInterfaceLogger logger)
    {
        ...
        await Task.WhenAll(Device.ExecuteAsync(logger, CancellationToken.None, SerialPortRequest.Create("3CM1", "OK3CM1")));
    }
